...
- (Legge di Bilancio 2025), specifically Article 49, which allowed certain WHO AWaRe “Reserve” antibiotics targeting multidrug-resistant organisms to access the national Innovative Medicines Fund.
...
![](images-new-abx/nytimes.png){fig-align="center" width="350"}
...
::: fragment
**Novel agents covered in this chapter:** Sulbactam-durlobactam (CRAB), multiple BL/BLI combinations & oral carbapenems (CRE/ESBL)
:::
...
## High priority pathogens {.smaller}
...
## Medium priority pathogens {.smaller}
...
::: fragment
These pathogens have a disproportionate impact on infants, young adults, and older adults, especially in resource-limited settings.
:::
...
## β-Lactamase classification: Ambler system {.smaller}
...
<br> **Class B MBLs** remain the greatest challenge - no approved inhibitor exists
:::
...
<br> Taniborbactam is the first inhibitor with activity against **VIM and most NDM** metallo-β-lactamases
:::
::::
...
<br> - **CRAB** → Sulbactam-durlobactam - **MBL-Enterobacterales** → ATM-AVI or FEP-TAN (when available) - **ESBL** → Cefepime-enmetazobactam - **XDR Pseudomonas** → Cefepime-zidebactam (when available)
:::

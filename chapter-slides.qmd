...
## Antibiotics in Advanced Development <br> & Key Initiatives for Antibiotic Development {background-video="/images-new-abx/molecules.mp4" background-video-loop="true" background-video-muted="true" background-color="#000000" background-opacity="0.3"}
...
Not approved in Italy (yet) but can be requested by emergency authorization
